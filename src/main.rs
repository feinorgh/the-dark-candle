...
use the_dark_candle::{
    ...
    entities::EntityPlugin, lighting::LightingPlugin, persistence::PersistencePlugin,
    physics::PhysicsPlugin, procgen::ProcgenPlugin, social::SocialPlugin, world::WorldPlugin,
};
